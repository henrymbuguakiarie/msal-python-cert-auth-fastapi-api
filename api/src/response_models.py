...
class ErrorResponse(BaseModel):
    ...
    errors: list[ErrorDetail] | None = Field(None, description="Detailed error list (for validation errors)")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "checks": {
                    "database": {"status": "healthy", "message": "Database is accessible"},
                    "jwks": {"status": "healthy", "message": "JWKS endpoint is accessible"}
                }
            }
        }
